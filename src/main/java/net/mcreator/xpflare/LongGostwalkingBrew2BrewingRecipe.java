...
public class LongGostwalkingBrew2BrewingRecipe extends XpflareModElements.ModElement {
	public LongGostwalkingBrew2BrewingRecipe(XpflareModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBrewingRecipe implements IBrewingRecipe {
		...
		public boolean isInput(ItemStack input) {
			...
			return (inputItem == Items.POTION || inputItem == Items.SPLASH_POTION || inputItem == Items.LINGERING_POTION)
					&& PotionUtils.getPotionFromItem(input) == Potions.LONG_INVISIBILITY;
		}
